...
public class RunFeedIn extends CommandBase {
  Intake _intake;
  
  /**
   * Creates a new RunFeedIn.
   */
  public RunFeedIn(Intake intake) {
    _intake = intake;
  }
  ...
  public void execute() {
    _intake.runFeedIn(true);
    System.out.println("Running FeedIn");
  }

  // Called once the command ends or is interrupted.
  @Override
  public void end(boolean interrupted) {
    _intake.runFeedIn(false);
  }
